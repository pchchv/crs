...
#include "ui_create_ride.hpp"

createRide::createRide(QWidget *parent) : QDialog(parent),
...
void createRide::on_submitBtn_clicked()
{
    ...
    if (newCarName.isEmpty() || newCarModel.isEmpty() || newCarEngine.isEmpty() || newCarColor.isEmpty() || newCarOwner.isEmpty())
    {
